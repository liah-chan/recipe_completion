...
def main():
	...
	similarities = list()
	for negative in range(1,21):	
		model_file = os.path.realpath(os.path.join(os.getcwd(),'./model_'+str(negative))) ######
	...
	# print similarities
	plot_similarity(parameters, similarities, para_name='negative_number')
